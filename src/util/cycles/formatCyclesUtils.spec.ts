...
describe("FormatCyclesUtils", () => {
    it("formatCyclesShort", () => {
        ...
        expect(formatCyclesShort(1e9, {billionAsTrillion: false})).toEqual("1 B")
        expect(formatCyclesShort(1e9, {billionAsTrillion: true})).toEqual("0.001 T")
        expect(formatCyclesShort(1.23e9, {maximumFractionDigits: 2, billionAsTrillion: false})).toEqual("1.23 B")
        expect(formatCyclesShort(1.23e9, {maximumFractionDigits: 2, billionAsTrillion: true})).toEqual("0 T")
