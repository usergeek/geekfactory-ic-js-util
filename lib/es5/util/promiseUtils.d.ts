export declare type RunCancelled = {
    state: "cancelled";
    error?: Error;
};
export declare type RunFailed = {
    state: "error";
    error: Error;
};
export declare type RunSuccess<R> = {
    state: "success";
    result: R;
};
declare type RunPromiseResult<R> = RunSuccess<R> | RunCancelled | RunFailed;
export declare type CancellableAsync<R, T extends (...args: any) => Promise<R>> = {
